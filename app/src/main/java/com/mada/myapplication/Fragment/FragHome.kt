...
/*
        ...
        CustomviewModel.buttonInfoEntity.observe(viewLifecycleOwner, Observer {
            Log.d("DataRepo", "Updated from ViewModel: ${it.colorButtonInfo?.serverID} ${it.clothButtonInfo?.serverID} ${it.itemButtonInfo?.serverID}")
            //updateUI(it)
        ...
        Log.d("DataRepo", "Before API Call: ${CustomviewModel.buttonInfoEntity.value?.colorButtonInfo?.serverID} ${CustomviewModel.buttonInfoEntity.value?.clothButtonInfo?.serverID} ${CustomviewModel.buttonInfoEntity.value?.itemButtonInfo?.serverID}")

        // getCustomPrint 함수 호출
        getCustomPrint(CustomviewModel)
