package com.mada.reapp.ChartFunction.Adaptor
...
class ChartMonthCategoryAdapter(private val context: Context) : RecyclerView.Adapter<ChartMonthCategoryAdapter.ViewHolder>() {
