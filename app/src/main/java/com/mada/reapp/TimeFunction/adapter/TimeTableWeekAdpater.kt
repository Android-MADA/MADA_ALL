package com.mada.reapp.TimeFunction.adapter
...
import com.mada.reapp.TimeFunction.TimeViewModel
import java.text.SimpleDateFormat
import java.util.Calendar
import java.util.Locale

class TimeTableWeekAdpater(private val data: ArrayList<TimeViewModel.PieChartData>,private val week: Int, private val viewModel: TimeViewModel) : RecyclerView.Adapter<TimeTableWeekAdpater.ViewHolder>() {
